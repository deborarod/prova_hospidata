object FConsultaFuncao: TFConsultaFuncao
  Left = 0
  Top = 0
  Caption = 'Consultar Fun'#231#227'o do Empregado'
  ClientHeight = 374
  ClientWidth = 685
  Color = clBtnFace
  ...
  object DBGrid1: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'nm_funcao'
        Title.Caption = 'FUN'#199#195'O DO EMPREGADO'
        Width = 479
        Visible = True
      end>
  end
  object QBusca: TZQuery
    ...
    SQL.Strings = (
      'select funcoes.* from funcoes')
    Params = <>
    Left = 16
    Top = 128
    object QBuscaid_funcao: TIntegerField
      FieldName = 'id_funcao'
      Required = True
    end
    object QBuscanm_funcao: TWideStringField
      FieldName = 'nm_funcao'
      Size = 100
    end
  end
